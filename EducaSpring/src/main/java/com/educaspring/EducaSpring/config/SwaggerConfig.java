package com.educaspring.EducaSpring.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.educaspring.EducaSpring.controllers")).build()
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder().title("EducaCiencia API")
				...
				.licenseUrl("https://www.evoluasumare.com.br").build();
	}
